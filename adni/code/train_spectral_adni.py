...
for fold in folds.keys():
    ...
    if fold == 4:
        if not plot_val:
            ...
            output.to_csv(f'/Users/magdalinipaschali/Documents/git/sample-weightning-ncanda/adni/analysis/weight_train_knn_{knn}_eigenbasis_{k}_centering_{centering}_adni_ad_mci.csv')
        else:
            concat_x = []
            concat_y = []
            concat_z = []
            ...
            fig.savefig(f"/Users/magdalinipaschali/Documents/git/sample-weightning-ncanda/adni/plots/weights_3d_all_knn_{knn}_eigenbasis_{k}_adni_ad_mci")
            plt.clf()
            # fig, ax = plt.subplots()
            ...
            plt.savefig(f"/Users/magdalinipaschali/Documents/git/sample-weightning-ncanda/adni/plots/hist_all_knn_{knn}_eigenbasis_{k}_adni_ad_mci")
            ...
            print(len(output))
            output.to_csv(f'/Users/magdalinipaschali/Documents/git/sample-weightning-ncanda/adni/analysis/weight_val_knn_{knn}_eigenbasis_{k}_centering_{centering}_adni_ad_mci.csv')
...
df_T.to_csv(f'/Users/magdalinipaschali/Documents/git/sample-weightning-ncanda/adni/analysis/guided_backprop_{knn}_eigenbasis_{k}_centering_{centering}_adni_ad_mci.csv')

# Keep the 15 largest columns
top_df_T = df_T.nlargest(15, 0)

brain_measurements = read_csv('/Users/magdalinipaschali/Documents/git/sample-weightning-ncanda/adni/brain_measurements.csv')
brain_measurements = list(brain_measurements["brain_measurements"])
...
def output_results(results):
    ...
    merged_preds_weights.to_csv(f'/Users/magdalinipaschali/Documents/git/sample-weightning-ncanda/adni/analysis/weights_pred_knn_{knn}_eigenbasis_{k}_centering_{centering}_adni_ad_mci.csv')
